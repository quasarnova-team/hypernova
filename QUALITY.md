...
| **DIP parity** | 10/10 | Every DIP capability present, most strictly better — see DIP-PARITY.md. Closed since v0.1: native Java client (was the one 🟡), name-server redundancy (mirror + failover), a DIP→hypernova migration bridge, and WinCC-OA consumption via the OPC UA bridge. |
